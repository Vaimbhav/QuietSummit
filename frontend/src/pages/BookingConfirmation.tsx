...
export default function BookingConfirmation() {
    ...
    if (loading) {
        return (
            <div className="min-h-screen flex items-center justify-center bg-linear-to-br from-primary-50 via-white to-blue-50">
    ...
    return (
        <div className="min-h-screen bg-linear-to-br from-emerald-50 via-teal-50 to-blue-50 relative overflow-hidden">
            {/* Decorative Background Elements */
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <div className="absolute top-20 left-10 w-96 h-96 bg-linear-to-br from-emerald-300 to-teal-300 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob"></div>
                <div className="absolute top-40 right-10 w-96 h-96 bg-linear-to-br from-blue-300 to-purple-300 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-2000"></div>
                <div className="absolute -bottom-8 left-20 w-96 h-96 bg-linear-to-br from-green-300 to-cyan-300 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-1000"></div>
            ...
            <div className="container mx-auto px-6 py-12 md:py-20 relative z-10 max-w-5xl">
                ...
                <motion.div
                    ...
                    className="mb-12"
                >
                    <div className="bg-white/95 backdrop-blur-2xl rounded-3xl shadow-2xl border-2 border-white/40 overflow-hidden">
                        {/* Gradient Header */
                        <div className="relative bg-linear-to-r from-emerald-600 via-primary-600 to-teal-600 px-6 md:px-12 py-8 md:py-10 text-center text-white overflow-hidden">
                            {/* Decorative circles */
                        ...
                        {/* Thank You Content */}
                        <div className="px-6 md:px-12 py-5 md:py-6 bg-linear-to-br from-white to-gray-50">
                            <div className="max-w-3xl mx-auto text-center space-y-3">
                                ...
                                >
                                    Your journey to <span className="font-black bg-linear-to-r from-primary-600 to-emerald-600 bg-clip-text text-transparent">{booking.destination}</span> is confirmed.
                                </motion.p>
                                ...
                                >
                                    <div className="inline-flex items-center gap-2 bg-linear-to-br from-green-50 to-emerald-50 text-green-700 px-5 py-2.5 rounded-xl font-bold border-2 border-green-200 shadow-sm text-sm">
                                        <CheckCircle className="w-4 h-4" />
                                        <span>Payment Confirmed</span>
                                    </div>
                                    <div className="inline-flex items-center gap-2 bg-linear-to-br from-blue-50 to-sky-50 text-blue-700 px-5 py-2.5 rounded-xl font-bold border-2 border-blue-200 shadow-sm text-sm">
                    ...
                    >
                        <div className="bg-white/90 backdrop-blur-2xl rounded-3xl shadow-2xl border-2 border-white/30 p-8 md:p-10 hover:shadow-3xl transition-shadow duration-300">
                            <h2 className="text-3xl font-black text-gray-900 mb-8 flex items-center gap-3 pb-4 border-b-2 border-gray-100">
                                <div className="w-10 h-10 bg-linear-to-br from-primary-500 to-blue-600 rounded-xl flex items-center justify-center">
                        ...
                        <div className="bg-white/90 backdrop-blur-2xl rounded-3xl shadow-2xl border-2 border-white/30 p-7 hover:shadow-3xl transition-shadow duration-300">
                            ...
                            <div className="space-y-4">
                                <button
                                    ...
                                    className="w-full px-5 py-4 bg-linear-to-r from-primary-600 to-blue-600 hover:from-primary-700 hover:to-blue-700 text-white font-bold rounded-xl transition-all hover:scale-105 hover:shadow-xl flex items-center justify-center gap-3 disabled:opacity-70 disabled:cursor-not-allowed shadow-lg"
                                >
                                ...
                                <button
                                    onClick={handleShare}
                                    className="w-full px-5 py-4 bg-linear-to-br from-gray-50 to-gray-100 hover:from-gray-100 hover:to-gray-200 text-gray-900 font-bold rounded-xl transition-all hover:scale-105 hover:shadow-lg flex items-center justify-center gap-3 border-2 border-gray-200"
                                >
                    ...
                    >
                        ...
                        <div className="grid md:grid-cols-2 gap-4">
                            {booking.travelers.map((traveler: any, index: number) => (
                                <div
                                    key={index}
                                    className="flex items-center gap-4 p-4 bg-linear-to-br from-gray-50 to-blue-50 rounded-2xl border border-gray-100"
                                >
                                    <div className="w-12 h-12 bg-linear-to-br from-primary-500 to-blue-500 rounded-full flex items-center justify-center text-white font-bold text-lg shadow-lg">
                                        {index + 1}
                                    </div>
                ...
                >
                    ...
                    <div className="relative">
                        {/* Timeline Line */}
                        <div className="absolute left-6 top-0 bottom-0 w-0.5 bg-linear-to-b from-primary-600 via-blue-500 to-purple-600"></div>

                        <div className="space-y-8">
                            {/* Step 1 */}
                            <div className="relative flex gap-6">
                                <div className="relative z-10 w-12 h-12 bg-linear-to-br from-green-400 to-emerald-500 rounded-full flex items-center justify-center text-white font-bold shadow-lg shrink-0">
                            ...
                            {/* Step 2 */}
                            <div className="relative flex gap-6">
                                <div className="relative z-10 w-12 h-12 bg-linear-to-br from-blue-500 to-blue-600 rounded-full flex items-center justify-center text-white font-bold shadow-lg shrink-0">
                                    2
                                </div>
                                <div className="flex-1 pt-1">
                            ...
                            {/* Step 3 */}
                            <div className="relative flex gap-6">
                                <div className="relative z-10 w-12 h-12 bg-linear-to-br from-purple-500 to-purple-600 rounded-full flex items-center justify-center text-white font-bold shadow-lg shrink-0">
                                    3
                                </div>
                                <div className="flex-1 pt-1">
                ...
                >
                    <button
                        ...
                        className="px-8 py-4 bg-linear-to-r from-primary-600 to-blue-600 hover:from-primary-700 hover:to-blue-700 text-white font-bold rounded-xl shadow-lg hover:shadow-xl transition-all hover:scale-105 flex items-center justify-center gap-2"
                    >
