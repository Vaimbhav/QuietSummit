                    ...
                    <div className="relative">
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="relative flex gap-6">
                                <div className="relative z-10 w-12 h-12 bg-gradient-to-br from-green-400 to-emerald-500 rounded-full flex items-center justify-center text-white font-bold shadow-lg shrink-0">
                            ...
                            {/* Step 2 */}
                            <div className="relative flex gap-6">
                                <div className="relative z-10 w-12 h-12 bg-gradient-to-br from-blue-500 to-blue-600 rounded-full flex items-center justify-center text-white font-bold shadow-lg shrink-0">
                                    2
                                </div>
                                <div className="flex-1 pt-1">
                            ...
                            {/* Step 3 */}
                            <div className="relative flex gap-6">
                                <div className="relative z-10 w-12 h-12 bg-gradient-to-br from-purple-500 to-purple-600 rounded-full flex items-center justify-center text-white font-bold shadow-lg shrink-0">
                                    3
                                </div>
                                <div className="flex-1 pt-1">
