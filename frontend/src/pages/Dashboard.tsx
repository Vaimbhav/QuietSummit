        ...
        <div className="min-h-screen bg-gradient-to-b from-primary-50 via-white to-neutral-50">
            ...
            <section className="relative bg-gradient-to-br from-primary-600 via-accent-600 to-primary-700 text-white py-12 sm:py-16 lg:py-20 overflow-hidden">
                <div className="absolute inset-0 overflow-hidden">
                    ...
                    <div className="absolute bottom-0 right-1/4 w-64 h-64 sm:w-96 sm:h-96 bg-accent-500/30 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
                </div>
                    ...
                    <div className="md:col-span-2 space-y-4 sm:space-y-6">
                        ...
                        <Card>
                            ...
                            <div className="space-y-4 sm:space-y-6">
                                <div>
                                    <label className="block text-xs sm:text-sm font-bold text-neutral-700 mb-2 sm:mb-3 flex items-center gap-2">
                                        ...
                                        {allInterests.map((interest) => (
                                            ...
                                            >
                                                <input
                                                    ...
                                                    className="w-4 h-4 sm:w-5 sm:h-5 rounded border-neutral-300 text-primary-600 flex-shrink-0"
                                                />
