  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'luxury-lg': '0 10px 40px -4px rgba(0, 0, 0, 0.12), 0 4px 16px -4px rgba(0, 0, 0, 0.06)',
        'luxury-xl': '0 20px 60px -8px rgba(0, 0, 0, 0.16), 0 8px 24px -8px rgba(0, 0, 0, 0.08)',
        'luxury-2xl':
      ...
      keyframes: {
        ...
        glow: {
          '0%': {
            textShadow: '0 0 20px rgba(74, 139, 112, 0.5), 0 0 30px rgba(74, 139, 112, 0.3)',
          },
          '100%': {
            textShadow: '0 0 30px rgba(74, 139, 112, 0.8), 0 0 40px rgba(74, 139, 112, 0.5)',
          },
        },
        shimmer: {
